...
export default function HomePage() {
  ...
  const trustBadges = [
    ...
    },
    {
      ...
      desc: "100% authentic medicines",
    },
    {
      icon: SupportAgent,
      title: "24/7 Support",
      desc: "Expert pharmacist help",
    },
  ...
  return (
    <Box>
      ...
      <Box
        sx={{
          background:
            "linear-gradient(135deg, #0f172a 0%, #0c4a6e 40%, #0369a1 70%, #0ea5e9 100%)",
          py: { xs: 8, md: 14 },
          px: { xs: 2, md: 4 },
          position: "relative",
          overflow: "hidden",
        ...
        <Container maxWidth="lg" sx={{ position: "relative" }}>
          <Grid container spacing={4} alignItems="center">
            <Grid size={{ xs: 12, md: 7 }}>
              <Chip
                label="Swami Shakti Ayurved Private Limited"
                sx={{
                  ...
                  <Chip
                    ...
                    onClick={() =>
                      handleCategoryChange(
                        tag === "Vitamins" ? "Vitamins & Supplements" : tag,
                      )
                    }
                    sx={{
                  ...
                  <Grid key={stat.value} size={{ xs: 6 }}>
                    ...
                    >
                      <Typography
                        ...
                        sx={{
                          background:
                            "linear-gradient(135deg, #38bdf8, #e0f2fe)",
                          WebkitBackgroundClip: "text",
                          WebkitTextFillColor: "transparent",
                        }}
                      >
      ...
      {/* ── Trust Badges ──────────────────────────────────── */}
      <Box
        sx={{ background: "white", borderBottom: "1px solid #e2e8f0", py: 3 }}
      >
      ...
      <Box
        id="offers"
        sx={{ py: 6, px: { xs: 2, md: 4 }, background: "#f1f5f9" }}
      >
        <Container maxWidth="lg">
          <Box
            sx={{
          ...
          >
            ...
            <Box>
              ...
              <Typography variant="body1" sx={{ color: "#93c5fd", mb: 3 }}>
                Use code <strong style={{ color: "white" }}>FIRSTMED</strong> at
                checkout.
              </Typography>
              <AppButton
                variant="secondary"
